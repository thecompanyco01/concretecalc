  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <article className="prose prose-slate max-w-none">
        ...
        <h3>How much does a 100-foot retaining wall cost?</h3>
        <p>
          A 4-foot tall, 100-foot long poured concrete retaining wall typically costs
          $10,000-$18,000 installed. Taller walls (6 feet) can reach $20,000-$30,000.
          Price per linear foot decreases slightly on longer walls due to shared
          mobilization costs.
        </p>

        <h3>Do I need a permit for a retaining wall?</h3>
        <p>
          In most US jurisdictions, yes — if the wall is over 4 feet tall (some areas say 3 feet).
          Permits typically cost $200-$500. Walls over 4 feet also usually require stamped
          engineering drawings ($500-$2,000).
        </p>

        <h3>How long does a concrete retaining wall last?</h3>
        <p>
          A properly built poured concrete retaining wall lasts <strong>100+ years</strong> with
          minimal maintenance. The key factors are proper drainage, adequate rebar, correct
          concrete mix (4,000+ PSI), and waterproofing. Walls that fail early almost always
          had drainage problems.
        </p>

        <h3>Can I build a retaining wall without engineering?</h3>
        <p>
          For walls under 4 feet in most jurisdictions, yes — though it&apos;s still recommended
          to follow standard design practices. Walls over 4 feet should always have engineering
          to ensure safety and meet code requirements. The $500-$2,000 engineering cost is
          cheap compared to a wall failure.
        </p>

        <h3>What&apos;s cheaper — concrete or block retaining wall?</h3>
        <p>
          Block (CMU) walls are typically 20-30% cheaper upfront. However, poured concrete
          walls last longer, require less maintenance, and are stronger for taller walls.
          For walls under 3 feet, block is usually the better value. For anything taller,
          poured concrete is worth the premium.
        </p>
      </article>
    </div>
  );
