...
export const metadata: Metadata = {
  title: "How to Start a Concrete Business in Virginia (VA) — 2026 Guide | EstimateConcrete",
  description: "Complete guide to starting a concrete business in Virginia. Licensing requirements, startup costs, equipment, insurance, and how to find your first customers in VA.",
  keywords: "how to start concrete business Virginia, concrete contractor license Virginia, concrete business VA",
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <nav className="text-sm text-slate-400 mb-6">
        ...
        {" / "}
        <span className="text-slate-800 font-medium">Start a Concrete Business in Virginia</span>
      </nav>

      <article className="prose prose-slate max-w-none">
        <h1>How to Start a Concrete Business in Virginia (VA)</h1>
        <p className="lead text-lg text-slate-600">
          Virginia is one of the best states for starting a concrete business. This guide covers
          everything you need — from licensing and insurance to equipment and finding your first customers in VA.
        </p>

        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 my-6 not-prose">
          <p className="text-sm text-blue-900">
            <strong>See also:</strong> <Link href="/states/virginia" className="text-blue-700 underline">Virginia concrete contractor guide</Link> — licensing details, current pricing, and top markets.
          </p>
        </div>

        <h2>Step 1: Get Licensed in Virginia</h2>
        <p>
          Licensing requirements vary by state. Check our <Link href="/states/virginia">Virginia state guide</Link> for
        ...
        <p>
          ...
          In Virginia, ready-mix concrete averages $130-$175 per cubic yard. Labor rates run $4-$9 per square foot
        ...
        <p>
          ...
          actual costs on the first 10 jobs to calibrate your estimates to Virginia pricing.
        </p>

        <h2>Startup Costs Summary for Virginia</h2>
        <table>
          <thead>
        ...
        <div className="bg-slate-900 text-white rounded-lg p-8 not-prose my-8 text-center">
          ...
          <p className="text-slate-400 mb-6 max-w-lg mx-auto">
            ...
            else you need to launch your concrete business in Virginia.
          </p>
          <Link
            href="/templates"
